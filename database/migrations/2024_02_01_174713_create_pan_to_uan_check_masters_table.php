...
class CreatePanToUanCheckMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pan_to_uan_check_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pan_to_uan_check_masters');
    }
}
