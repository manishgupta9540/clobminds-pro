...
class CreateDigitalEmploymentChecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('digital_employment_checks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('digital_employment_checks');
    }
}
