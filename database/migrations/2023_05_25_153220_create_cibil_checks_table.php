...
class CreateCibilChecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('cibil_checks');
    }
}
