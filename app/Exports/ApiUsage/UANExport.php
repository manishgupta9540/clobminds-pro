...
class UANExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    ...
    {
        $new_arr=[$data->uan_number,Helper::user_name($data->user_id),date('d-F-Y h:i A',strtotime($data->created_at)),'₹ '.$data->price];
