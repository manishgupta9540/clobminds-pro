...
class CIBILExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    ...
    {
        $new_arr=[$data->pan_number,$data->name,Helper::user_name($data->user_id),date('d-F-Y h:i A',strtotime($data->created_at)),'₹ '.$data->price];
