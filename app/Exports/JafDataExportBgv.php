...
class JafDataExportBgv implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    ...
    public function collection()
    {
        ...
        $query = DB::table('users as u')
                    ->select('u.*','ub.company_name',DB::raw('group_concat(jf.id) as jaf_id'),'ub.city_name')
