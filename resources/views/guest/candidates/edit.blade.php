      ...
      <div class="row">
         <div class="card newrequestcard">
            <div class="card-body verify">
               ...
               <form class="mt-2" method="post" id="editCandidateForm" action="{{ url('/guest/candidates/update') }}" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row requestrow">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control first_name" name="first_name" id="first_name" value="{{$user->first_name}}" placeholder="Enter their first name">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control middle_name" name="middle_name" id="middle_name" value="{{$user->middle_name}}" placeholder="Enter their middle name">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control last_name" name="last_name" id="last_name" value="{{$user->last_name}}" placeholder="Enter their last name">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control father_name" name="father_name" id="father_name" value="{{$user->father_name}}" placeholder="Enter their father's name">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control aadhar" id="aadhar" value="{{$user->aadhar_number}}" placeholder="Enter Aadhar Number">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" name ="phone" id="phone1" class="number_only form-control phone" style='display:block;' value="{{$user->phone}}">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="email" class="form-control email" name="email" id="email" value="{{$user->email}}" placeholder="Please enter their best contact email">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="date" class="form-control dob" name="dob" id="dob" value="{{ date('d-m-Y', strtotime($user->dob)) }}">
