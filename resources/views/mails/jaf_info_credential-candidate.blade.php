                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">Dear  {{$name}},Greetings from {{Helper::company_name($candidate->parent_id)}} </h1>
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 10px; text-align: left;">{{Helper::company_name($candidate->parent_id)}}  has been authorized by {{$company_name}}, to perform background verification for your good self. Therefore, we request you to please login to the portal, read the terms and conditions carefully and upload all the Mandatory documents and information requested for:</strong>. </p>
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Case Id: </b> {{$candidate->display_id}}</p>
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Please note, this link will be active for 48 hours only. Kindly assist us in getting your background verification done at the earliest to speeden up the process of your on-boarding at {{$company_name}}.In case of any technical queries Please contact 08041132079 or write to us on :
                                        ...
                                        Clobmind Team-{{Helper::company_name($candidate->parent_id)}}<br>
