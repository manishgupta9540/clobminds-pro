                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 10px; text-align: left;">Please note, we have raised an insufficiency for Case Reference {{$candidate->display_id}}, for {{$companyname}} verification on {{$candidate->updated_at==NULL ? date('d-F-Y h:i:s a',strtotime($candidate->insuff_date)) : date('d-F-Y h:i:s a',strtotime($candidate->updated_at))}} for {{$candidate->name}}.</p>
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b> We request you to  : </b>  <a href="{{ Config::get('app.client_url')}}" class="button button-blue" target="_blank" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"> Login</a> to the portal and address the insufficiency at your earliest convenience, allowing us to complete the Background Verification for the candidate.</p>
