                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 QC-data">
                                    <h3 class="card-title mb-3"> QC Form </h3>
                                        ...
                                        <div class="data">
                                            <p><strong>Address :</strong> {{ $candidate->address_line1.' '.$candidate->address_line2}}</p>
                                        </div>
                                        <div class="data">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered table-collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td><strong>Type of address:</strong> {{ $candidate->address_type }}</td>
                                                <td>
                                                    <div class="form-check form-check-inline">
                            ...
                            <div class="row mt-30">
                                <div class="col-md-6">
                                    <div class="data-selfie">
                                        ...
                                        @if($candidate->selfi_photo !="" || $candidate->selfi_photo !=null)
                                            <img src="{{ url('/').'/uploads/candidate-selfie/'.$candidate->selfi_photo }} ">
                                        @else
                                        <img src="{{ asset('admin/images/photo-default.png') }} ">
                                        @endif
                                        <div class="img-data">
                                ...
                                <div class="col-md-6">
                                    <div class="data-selfie">
                                        ...
                                        @if($candidate->address_proof_photo_1 !="" || $candidate->address_proof_photo_1 !=null)
                                            <img src="{{ url('/').'/uploads/address-proof/'.$candidate->address_proof_photo_1 }} ">
                                        @else
                                        <img src="{{ asset('admin/images/photo-default.png') }} ">
                                        @endif
                                        <div class="img-data">
                            ...
                            <div class="row mt-30 mb-50">
                                ...
                                <div class="form-group">
                                    <label for="sel"> Your Decision</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="decision_comment" rows="4"></textarea>
                                </div>
