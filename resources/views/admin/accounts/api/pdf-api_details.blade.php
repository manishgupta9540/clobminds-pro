                ...
                <thead class="thead-light" style="text-align: center;">
                    <tr>
                        ...
                        @elseif(stripos($service_d->type_name,'uan-number')!==false)
                            <th style="border-right: 1px solid black;border-bottom: 1px solid black;">UAN Number</th>
                        @elseif(stripos($service_d->type_name,'cibil')!==false)
                            <th style="border-right: 1px solid black;border-bottom: 1px solid black;">PAN Number</th>
                            <th style="border-right: 1px solid black;border-bottom: 1px solid black;">Name</th>
                        @endif
                    ...
                    @if($data!="" && count($data)>0)
                        @foreach ($data as $key => $d)
                            <tr>
                                ...
                                @elseif(stripos($service_d->type_name,'uan-number')!==false)
                                    <td style="border-right: 1px solid black;border-bottom: 1px solid black;">{{$d->uan_number}}</td>
                                @elseif(stripos($service_d->type_name,'cibil')!==false)
                                    <td style="border-right: 1px solid black;border-bottom: 1px solid black;">{{$d->pan_number}}</td>
                                    <td style="border-right: 1px solid black;border-bottom: 1px solid black;">{{$d->name}}</td>
                                @else
