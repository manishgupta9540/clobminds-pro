             ...
             <div class="modal-body">
                <div class="row">
                   ...
                   <div class="col-12">
                      ...
                      <div class="row my-4">
                        <div class="col-8">
                           <a href="javascript:;" class="add_data"><i class="fa fa-plus"></i> Add</a>
                        </div>
                        <div class="col-4">
                           <div class="form-group">
                              <label class="checkbox-inline cursor-pointer">
                                    <input type="checkbox" class="send_candidate" name="send_candidate">
                                    <span class="pl-2">Send to Candidate</span>
                              </label>
                           </div>
                        </div>
                      </div>
...
<script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.editBtn', function (event) {
            ...
            $('.send_candidate').attr('checked',false);
            ...
            $.ajax({
               ...
               success: function (data) {
                  ...
                  { 
                        ...
                        if(data.notify_control!=null && data.notify_control.is_send_candidate==1)
                        {
                           $('.send_candidate').attr('checked',true);
                        }
