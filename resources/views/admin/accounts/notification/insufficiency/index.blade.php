                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-9">
                                       ...
                                       <span>
                                          Note:- Enable that client to send the mail on every 24 hours if insufficiency has not been cleared. (Enter the email address via edit button to which you want to send the mail).
                                       </span>
                                       <p class="pb-border"></p>
                                    </div>
