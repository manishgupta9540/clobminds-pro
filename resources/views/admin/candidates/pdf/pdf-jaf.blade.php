...
<html>
  <head>
    <title>Background Verification Form </title>
  <style>
  ...
  <h3 style="text-align: center; font-weight:400;  padding: 5px; font-size:16px; background-color: #c4e3ee; color:#226277; border: 1px solid #226277;">Background Verification Form</h3>
  <br>
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="" >
    ...
    @if( count($jaf_items) >0)
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="main" >
          ...
          //name
            ?>
            <tr>
              @if(stripos($item->type_name,'drug_test')!==false)
    ...
    <table cellpadding="0" width="100%" cellspacing="0" class="main" >
      ...
      <tr>
        <td colspan="2" style="border-bottom: 1px solid #226277;border-right: 1px solid #226277; "> I authorize Screenase to contact my present employer. ​☐ Yes ☐ No</td>  
      </tr>
      <tr>
