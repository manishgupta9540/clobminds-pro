         ...
         <div class="row">
            ...
            <div class="col-md-9 col-12" style="background: #f6f8fc;">
               ...
               <ul class="nav nav-pills" id="myPillTab" role="tablist" style="border-bottom: 1px solid #cdd1d8;">
                  ...
                  {{-- <li class="nav-item"><a class="nav-link" id="contact-icon-pill" data-toggle="pill" href="#contactPIll" >  Call </a></li> --}}
                              ...
                              <form class="mt-2" method="post" enctype="multipart/form-data" action="{{ url('/candidates/jafFormUpdate') }}" id="jaf_form">
                                 ...
                                 <div class="row">
                                   @if ($message = Session::get('success'))
                                    ...
                                    ?>
                                    @php
                                       $get_reports_status = Helper::get_report_send_rework_comments($candidate->id);
                                    @endphp
                                    <div class="col-12">
                                       <div class="row">
                                          <div class="col-sm-9">
                                          ...
                                          <div class="col-sm-3" style="">
                                             ...
                                             <button class="btn btn-sm btn-info sendToRework" data-candidate="{{base64_encode($candidate->id)}}" data-business="{{base64_encode($candidate->business_id) }}" type="button">Requested For re-work</button>
                                             @endif
                                          </div>
                                       </div>
                                    </div>
                                                ...
                                                @if($candidate->is_all_insuff_cleared ==0 && ($report_status==NULL || $report_status['status']=='incomplete' ))
                                                   ...
                                                   @if(Auth::user()->user_type=='customer')
                                                      <div class="form-group">
                                                         <a href="javascript:;" class="btn btn-sm btn-danger all_insuff_clear_btn" data-id="{{ base64_encode($candidate->id) }}" name="all_insuff_clear_btn" > Mark as all Insuff cleared </a>
                                                      ...
                                                      @if(Auth::user()->user_type=='customer')
                                                         <div class="form-check  pt-2" >
                                                            <label class="check-inline {{$disable_link_cls}}" style="font-size: 14px;">
                                                               <input type="checkbox" class="jaf-ready-report" id="jaf-ready-report" name="jaf-ready-report" class="form-check-input" {{$jaf_report_check}} {{$disable_attr}}> BGV Ready for Report
                                                            </label>
                                                         </div>
                                                      @else
                                                         @if ($kams)
                                 ...
                                 {{-- <div class="row pt-3">
                                       <div class="col-md-12">
                                          <h3 class="text-center">BGV Info </h3>
                                          <p class="pb-border"></p>
                                       </div>
                                 </div>    --}}
                                          ...
                                          @foreach($jaf_items as $item)
                                             ...
                                             <div class="row" style="padding: 10px 0; margin-top:10px; border:1px solid #ddd;">
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <p>{{ Helper::user_reference_id($candidate->id).'-'.$item->short_name }}{{stripos($item->verification_type,'Manual')!==false ? '-'.$item->check_item_number : ''}}</p>
                                                   <div class="row">
                                                      <div class="col-sm-4">
                                                      ...
                                                      <div class="col-sm-4">
                                                         <div class="form-group">
                                                            @if($disabled_link=='')
                                                               <button class="btn btn-sm btn-outline-info addChargesBtn {{$disabled_link}} check-input-{{$item->id}}" type="button" data-id="{{base64_encode($item->id)}}"> Additional Charge</button>
                                                            @endif
                                                         </div>
                                                      </div>
                                                      <div class="col-sm-4">
                                                      ...
                                                      @if($item->service_id == '1')
                                                               ...
                                                               <div class="form-group">
                                                                  <div class="form-check">
                                                                     <label class="check-inline @if($digital_data!=NULL) disabled-link @endif {{$disabled_link}}">
                                                                        <input type="checkbox" data-digital_id="{{ $item->id }}" name="digital-verification-checkbox-{{ $item->id}}" class="form-check-input digital_verification check-input-{{$item->id}}" @if ($digital_data) checked disabled @endif>Digital Verification
                                                                     </label>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         ...
                                                         @if($digital_data!=NULL && ($address_ver==NULL || $address_ver->status==0))
                                                            <div class="row pl-3 pr-3 d-flex justify-content-between">
                                                               ...
                                                               {{-- <div class="send-sms-div-{{$item->id}} ">
                                                                  <div class="form-group">
                                                               ...
                                                               <div class="send-mail-div-{{$item->id}} ">
                                                                  <div class="form-group">
                                                            ...
                                                            {{-- <div class="row pr-3 pl-3 d-flex justify-content-between">
                                                               <div class="send-sms-mail-div-{{$item->id}} ">
                                                                  <div class="form-group">
                                                         ...
                                                         <div class="row" >
                                                            <div class="col-sm-12">
                                                                  ...
                                                                  <label>Address Type <span class="text-danger">*</span></label>
                                                                     <select class="form-control {{$disabled_link}} address-type-{{$item->id}} check-input-{{$item->id}}" name="address-type-{{$item->id}}" {{$readonly}} >
                                                            ...
                                                            <div class="row {{$labelname}}">
                                                                  ...
                                                                  <div class="form-group">
                                                                     ...
                                                                     @elseif(stripos($item->type_name,'drug_test_5')!==false || stripos($item->type_name,'drug_test_6')!==false || stripos($item->type_name,'drug_test_7')!==false || stripos($item->type_name,'drug_test_8')!==false || stripos($item->type_name,'drug_test_9')!==false || stripos($item->type_name,'drug_test_10')!==false)
                                                                        @if(stripos($key_val[0],'Test Name')!==false)
                                                                           <label>  {{ $key_val[0]}} </label><br>
                                                                           <input type="hidden" name="service-input-label-{{ $item->id.'-'.$i }}" value="{{ $key_val[0]}}">
                                                                           <input class="form-control check-input-{{$item->id}}" type="hidden" name="service-input-value-{{ $item->id.'-'.$i }}" value="{{ $input_val[0] }}">
                                                                           @php
                                                               ...
                                                               <div class="col-sm-1">
                                                                  ...
                                                                  <label class="{{$label}}"> Remarks </label>
                                                                      ...
                                                                      <input type="checkbox" id="remarks-input-checkbox-{{ $item->id.'-'.$i}}" name="remarks-input-checkbox-{{ $item->id.'-'.$i}}"  @if(in_array('remarks', $key_val)) @if($input['remarks']=='Yes') checked @endif @endif class="form-check-input {{$label}} check-input-{{$item->id}}" >
                                                                      </label>
                                                                      </div>
                                                                  </div>
                                                               </div>
                                                               ...
                                                               <div class="col-sm-5">
                                                                  ...
                                                                  <label class="{{$label}}"> Remarks Message</label>
                                                                     ...
                                                                     ?>
                                                                     <select class="form-control remark_msg {{$label}} check-input-{{$item->id}}" name="remarks-input-value-{{ $item->id.'-'.$i}}" data-item_id="{{  $item->id }}" data-id="{{ $i }}">
                                                                        <option value="">-Select-</option>
                                                                  ...
                                                                  <div class="col-sm-6">
                                                                     <div class="form-group">
                                                                        <label class="checkbox-inline ">
                                                                           ...
                                                                           ?>
                                                                              <input type="checkbox" name="executive-summary-{{ $item->id .'-'.$i}} check-input-{{$item->id}}" @if ($is_executive_summary)
                                                                                    
                                                                              @if($is_executive_summary == '1')  checked @endif @endif > Executive Summary Output (if yes: Check Mark)
                                                                        </label>
                                                                     </div>
                                                                     <div class="form-group">
                                                                        <label class="checkbox-inline {{$label}} check-input-{{$item->id}}">
                                                                           <input type="checkbox" name="table-output-{{ $item->id.'-'.$i }}" @if($is_report_output == '1')  checked @endif > Check's Table Output (if yes: Check Mark)
                                                                        </label>
                                                                     </div>
                                                                  </div>
                                                      ...
                                                      <div class="row">
                                                         <div class="col-sm-12" style="border:1px solid #ddd; padding:10px; margin-bottom:10px;">
                                                            ...
                                                            <div class="col-sm-12">
                                                                  ...
                                                                  <div class="form-check">
                                                                     <label class="form-check-label">
                                                                        <input style="margin-top: 1px;" type="checkbox" class="form-check-input check-input-{{$item->id}}"  @if($item->is_insufficiency == 1) checked @endif name="insufficiency-{{ $item->id }}" disabled>Mark as insufficiency
                                                                     </label>
                                                                  </div>
                                                                  </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                  <div class="form-group">
                                                                     ...
                                                                     <input type="text" class="form-control error-control check-input-{{$item->id}}" name="insufficiency-notes-{{$item->id }}" value="{{ $item->insufficiency_notes}}" readonly>
                                                                  </div>
                                                            </div>
                                                ...
                                                @php $service_name=Helper::service_attachment_type($item->service_id); @endphp
                                                   ...
                                                   <div class="col-md-4">
                                                            ...
                                                            <select name="service_type" class="form-control service_select_main" id="service_select_main-{{$item->id}}" data-type="main" data-select="{{$item->id}}">
                                                               <option value="" data-name="select">-Select-</option>
                                                               @foreach($service_name as $sname)
                                                               <option value="{{$sname->id}}" data-name="{{preg_replace('/[\x00-\x1F\x7F-\xFF]/', '', $sname->attachment_name)}}">{{preg_replace('/[\x00-\x1F\x7F-\xFF]/', '', $sname->attachment_name)}}</option>
                                                               @endforeach
                                                            </select>
                                 ...
                                 @else
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="row">
                                                      ...
                                                      <div class="col-sm-4">
                                                         <div class="form-group">
                                                            @if($disabled_link=='')
                                                               <button class="btn btn-outline-info addChargesBtn {{$disabled_link}}" type="button" data-id="{{base64_encode($item->id)}}"> Additional Charge</button>
                                                            @endif
                                                         </div>
                                                      </div>
                                                      <div class="col-sm-4">
                                                      ...
                                                      <div class="row {{$labelname}}">
                                                         ...
                                                         <div class="col-sm-5">
                                                            ...
                                                            <label class="{{$label}}"> Remarks Message</label>
                                                               ...
                                                               ?>
                                                               <select class="form-control remark_msg check-input-{{$item->id}} {{$label}}" name="remarks-input-value-{{ $item->id.'-'.$i}}" data-item_id="{{  $item->id }}" data-id="{{ $i }}">
                                                                  <option value="">-Select-</option>
                                                                  <option value="clear" {{ $remarks_message == 'clear' ? 'selected' : '' }}>Verified Clear</option>
                                                                  <option value="no_record" {{ $remarks_message == 'no_record' ? 'selected' : '' }}>No Record Found</option>
                                                                  <option value="unable_verify" {{ $remarks_message == 'unable_verify' ? 'selected' : '' }}>Unable to Verify</option>
                                                   ...
                                                   <!-- ./check outputs -->
                                                         ...
                                                         <div class="row {{$label}}">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <div class="form-group @if($remarks_custom_message=='') d-none @endif " id="msg-{{ $item->id.'-'.$i }}" >
                                                                  <input type="text" name="remarks-msg-{{ $item->id.'-'.$i}}"  class="form-control check-input-{{$item->id}}" value="{{ $remarks_custom_message }}">
                                                               </div>
                                                            </div>
                                                         </div>
                                                            {{-- <div class="col-sm-6">
                                                ...
                                                @php $service_name=Helper::service_attachment_type($item->service_id); @endphp
                                                   ...
                                                   <div class='row fileResult' id="fileResult1-{{$item->id}}" style='min-height: 20px; margin-top: 20px;'>
                                                      ...
                                                      <?php 
                                                         ...
                                                         $attached_files = Helper::getAttachedFileName($attached_file_id); //print_r($item_files);
                                    ...
                                    @else
                                       ...
                                       @if (count($jaf_items) >0)
                                          <div class="col-sm-12 text-center"> You have no access to View BGV Details</div>
                                       @else
                                          <div class="col-sm-12"> BGV data is not Completed! </div>
                                       @endif
                                    @endif
...
<div class="modal" id="myImageModal">
   <div class="modal-dialog modal-lg">
     <div class="modal-content">
       ...
       <!-- Modal body -->
       <div class="modal-body">
         <img class="image-modal-content border" id="img01" style="width: 100%;">
         <div id="caption"></div>
       </div>
...
<div class="modal" id="rework_request_recieve_modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
      <form action="{{url('/report/rework/status')}}" method="post" id="RequestToRework" enctype="multipart/form-data">
         <!-- Modal Header -->
         <div class="modal-header">
            <h4 class="modal-title" id="ser_name"></h4>
            {{-- <button type="button" class="close closeraisemdl" data-dismiss="modal">&times;</button> --}}
           ...
           <input type="hidden" name="jaf_id" id="jaf_id"> -->
            <div class="modal-body">
               ...
               <div class="col-md-12">
                  <div class="row">
                     @csrf
                     <input type="hidden" name="business_id" id="business_id" value="{{$candidate->business_id}}">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
               <button type="submit" class="btn btn-success send_to_submit send_submit" >Submit </button>
...
$(document).ready(function(){
   ...
   $(document).on('click','.sendToRework',function(){
               ...
               $('#jaf_id').val(jaf_id);
                  ...
                  $.ajax({
                     type:'GET',
                     url: "{{route('/report/send_rework_detail')}}",
                     data: {'candidate_id':can_id,'business_id':business_id},        
                     success: function (response) {        
                     // console.log(response.html);
                        
                        $('#raise_data').html(response.form);
                        $('#ser_name').text('Verification - '+response.service_name);
                        $('#rework_request_recieve_modal').modal({
                           backdrop: 'static',
                           keyboard: false
                        });
                        $('.address_data').html(response.html);
...
$(document).on('submit', 'form#RequestToRework', function (event) {
   ...
   $.ajax({
      ...
      //  }
         if (data.fail == false) {
               // $('#send_otp').modal('hide');
               // alert(data.id);
               toastr.success("Report Re-work has been done");
               // redirect to google after 5 seconds
               window.setTimeout(function() {
               location.reload(); 
               }, 2000);
