                        ...
                        <div class="card text-left">
                            <div class="card-body">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 form-group mt-4">
                                            <a class="btn-link" id="exportExcel1" href="javascript:;"> <i class="fa fa-file-excel-o"></i> Export Excel Bgv</a> 
                                            <p style="margin-bottom:2px;" class="load_container text-danger" id="loading"></p>
                                        </div>
...
$(document).ready(function(){
    ...
    $(document).on('click','#exportExcel1',function(){
