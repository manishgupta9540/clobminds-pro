    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr>
        <td colspan="2" style="padding: 5; text-align:center ">
          <h3 style="text-align: center; font-weight:400;  padding: 5px; font-size:18px; color:#333; "><b>Adhar To Uan Verification </b></h3>
        </td>
      </tr>
      
        <tr> <td style="padding:7px; border:1px solid #666; width:30%">Adhar Validity</td> 
        ...
        <tr> 
            <td style="padding:7px; border:1px solid #666;">Adhar Number</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$master_data->aadhaar_number}} </strong></td> 
        </tr>
        <tr> 
            <td style="padding:7px; border:1px solid #666;">Uan Number</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$master_data->pf_uan}} </strong></td> 
        </tr>
      <!--  -->
    </table>
