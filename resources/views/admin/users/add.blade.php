...
<div class="clearfix"></div>
 ...
 <form action="{{route('/admin/users/store')}}" id="addCustomerForm" method="post" style="padding: 10px 80px;">
  @csrf
 
  <div class="row">
  
    <div class="col-12 col-lg-4 col-xl-4">
        <div class="text-uppercase"> Personal Details </div>
      </div>
  ...
  <div class="card">
        <div class="card-body">
           ...
           <div class="input-group mb-3">
            <span class="input-group-addon">+061</span>
