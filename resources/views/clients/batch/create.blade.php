                    ...
                    <!-- select a customer  -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group jaf_file">
                                ...
                                <input type="file" name="file" multiple id="files" accept=".zip,.pdf" class="form-control error-control files">
                                <p style="margin-bottom: 2px;" class="text-danger error-container" id="error-file"></p>  
                             </div>
